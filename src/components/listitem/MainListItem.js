...
const MainListItem = ({ post }) => {
    return (
        <Link key={post.id} to={"/community/"+post.id} className="block max-w px-6 py-3 my-3 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100">
